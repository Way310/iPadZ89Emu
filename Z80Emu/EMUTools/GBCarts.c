...
/*************************************************************/
static struct { unsigned char Code;char *Name; } Companies[] =
{
...
/*************************************************************/
static struct { unsigned char Type;char *Name; } TypeNames[] =
{
  { 0x00,"ROM ONLY" },
  { 0x01,"ROM+MBC1" },
  { 0x02,"ROM+MBC1+RAM" },
...
/*************************************************************/
unsigned char GB_MakerID(unsigned char *Header)
{
...
/*************************************************************/
int GB_ROMBanks(unsigned char *Header)
{
  int J;
...
{
  static int Sizes[6] = { 0,2048,8192,32768,131072,65536 };
...
/*************************************************************/
char *GB_Type(unsigned char *Header)
{
  int Type,J;
...
/*************************************************************/
unsigned char GB_Battery(unsigned char *Header)
{
  static unsigned char BatteryTypes[12] =
